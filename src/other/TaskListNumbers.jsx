...
const TaskListNumbers = ({ data }) => {
    return (
        <div className='flex mt-10 justify-between gap-5 screen'>
            ...
            <div className='rounded-xl w-[45%] py-6 px-9 bg-blue-500 shadow-lg shadow-blue-500/20 hover:scale-[1.02] transition-all duration-200'>
            ...
            <div className='rounded-xl w-[45%] py-6 px-9 bg-emerald-500 shadow-lg shadow-emerald-500/20 hover:scale-[1.02] transition-all duration-200'>
            ...
            <div className='rounded-xl w-[45%] py-6 px-9 bg-amber-500 shadow-lg shadow-amber-500/20 hover:scale-[1.02] transition-all duration-200'>
            ...
            <div className='rounded-xl w-[45%] py-6 px-9 bg-rose-500 shadow-lg shadow-rose-500/20 hover:scale-[1.02] transition-all duration-200'>
